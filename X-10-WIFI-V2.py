#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Modify History : rofl0r => ARIF_MODZ => Mohammad_Alamin (Toxinum) (ARIF_MODZ)
# VERSION 1.0.1
...
def usage():
    return """
ARIF 0.0.2 (c) 2017 rofl0r (modified).
        ...
        try:
            ...
            if args.loop:
                if input("\n[?] Exit the script (otherwise continue to AP scan)? [N/y] ").lower() == 'y':
                    ani("\n[\033[1;31m!\033[1;37m] Create by ARIF_MODZ.🐸😁…")
                    break
                else:
                    args.bssid = None
            else:
